...
def ua(days_in_period: int, daily_heat_usage: float, BTU_per_usage: float, 
       heat_sys_efficiency: float, period_hdd: int) -> float:
...
def uas(fuel_type: str, balance_point: float, non_heating_usage: float, 
    ...
    return [ua(days_in_bills[period], avg_daily_heating_usages[period],
               BTU_per_usage, heat_sys_efficiency, period_hdds[period])
