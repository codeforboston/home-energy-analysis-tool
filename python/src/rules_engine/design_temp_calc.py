...
def run_tests(home_addresses):
    ...
    # Run for close addresses, 30-year window
    for address in home_addresses:
        ...
        temp_30, elapsed_30 = calculate_design_temperatures(
            lat, lon, start_30_year, end_30_year
        )
...
def main():
    """
    Run the tests in main, then print off results into a table for each collection of
    close home addresses and homes located between weather stations
    """

    print("Starting the program now...")

    # calculate temp data (30 years) for home addresses close to station
