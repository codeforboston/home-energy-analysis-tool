...
for (const [filePath, data] of Object.entries(coverage)) {
  ...
  if (filePath.endsWith('.ts') && 
    ...
    if (Object.keys(statements).length > 0 && Object.values(statements).every(count => count === 0)) {
      const relativePath = filePath.replace('/Users/ethanadmin/projects/home-energy-analysis-tool/heat-stack/', '');
