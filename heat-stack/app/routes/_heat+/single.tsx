...
export async function action({ request, params }: Route.ActionArgs) {
    ...
    */
    ...
    const gasBillDataFromTextFilePyProxy: PyProxy = executeGetAnalyticsFromFormJs(parsedAndValidatedFormSchema, convertedDatesTIWD, uploadedTextFile, state_id, county_id)
...
export default function SubmitAnalysis({
    ...
    const defaultValue: SchemaZodFromFormType | MinimalFormData | undefined = loaderData.isDevMode ? {
        living_area: 2155,
