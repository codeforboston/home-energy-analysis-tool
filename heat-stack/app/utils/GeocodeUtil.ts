...
class GeocodeUtil {
     ...
     */
    async getGeoData(address: string) {
        ...
        let compositeKey = {state: jrez.result.addressMatches[0].geographies.Counties[0].STATE, county: jrez.result.addressMatches[0].geographies.Counties[0].COUNTY};
        // console.log(JSON.stringify(jrez, null, 2));
        return {coordz,compositeKey};
    }
}
