...
If modifying an existing file, check if it is part of the original Epic Stack
codebase. If it is, read
[Guidelines for Editing Epic Stack Fie](./docs/guidelines-for-editing-epic-stack-files.md).
