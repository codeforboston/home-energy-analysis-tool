...
INSERT INTO "new_ProcessedEnergyBill" ("analysisInputId", "analysisType", "defaultInclusion", "id", "periodEndDate", "periodStartDate", "usageQuantity", "wholeHomeHeatLossRate") SELECT "analysisInputId", "analysisType", "defaultInclusion", "id", "periodEndDate", "periodStartDate", "usageQuantity", "wholeHomeHeatLossRate" FROM "ProcessedEnergyBill";
